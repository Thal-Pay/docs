...
Acesse o [Dashboard Thalpay](https://dashboard.thalpay.com) e crie sua conta. Apos aprovacao do cadastro, voce tera acesso ao painel para gerar suas API Keys.
